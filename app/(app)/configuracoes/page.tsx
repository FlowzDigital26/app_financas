...
export default function ConfiguracoesPage() {
  ...
  return (
    <div className="space-y-6 max-w-xl">
        ...
        {loadingProfile ? (
          ...
          <>
            ...
            <div className="flex flex-col gap-1.5 text-right shrink-0">
              <div className="bg-accent/10 text-accent text-xs font-semibold px-2.5 py-1 rounded-full">
                Grátis
              </div>
            </div>
          </>
      ...
      <Dialog open={pwOpen} onOpenChange={(o) => { setPwOpen(o); if (!o) { setCurrentPw(''); setNewPw(''); setConfirmPw('') } }}>
